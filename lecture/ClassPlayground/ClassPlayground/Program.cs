...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Zadej x souradnici bodu");
            int x = int.Parse(Console.ReadLine());
            Console.WriteLine("Zadej y souradnici bodu");
            int y = int.Parse(Console.ReadLine());
            Rectangle newRectangle = new Rectangle(width, height, x, y);
            newRectangle.CalculateArea(width, height);
            newRectangle.CalculateAspectRatio(width, height);
            newRectangle.ContainsPoint(width,height,x,y);
