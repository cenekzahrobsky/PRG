...
namespace Files
{
    internal class Program
    {
        ...
        class Person
        {
            ...
            {
                string filePath = "H:\\Semin\\CSH4\\Zahrobsky\\PRG\\lecture\\Files\\" + Name + ".txt";
                using (StreamWriter writer = new StreamWriter(filePath))
                {
                    writer.WriteLine(Name + " " + Height + " " + Weight);
                }
            ...
            {
                Console.WriteLine("Enter name of the new person:");
                string fileName = Console.ReadLine();
                string filePath = "H:\\Semin\\CSH4\\Zahrobsky\\PRG\\lecture\\Files\\" + fileName + ".txt";
                using (StreamReader reader = new StreamReader(filePath))
                {
                    string[] strings = reader.ReadToEnd().Split(' ');
                    Person person = new Person(strings[0], float.Parse(strings[1]), float.Parse(strings[2]));
            ...
            {
                string filePath = "H:\\Semin\\CSH4\\Zahrobsky\\PRG\\lecture\\Files\\" + Name + ".csv";
                using (StreamWriter writer = new StreamWriter(filePath))
                {
                    writer.WriteLine(Name + "," + Height + "," + Weight);
                }
            ...
            public static Person LoadFromCsv()
            {
                Console.WriteLine("Enter name of the new person:");
                string fileName = Console.ReadLine();
                string filePath = "H:\\Semin\\CSH4\\Zahrobsky\\PRG\\lecture\\Files\\" + fileName + ".csv";
                using (StreamReader reader = new StreamReader(filePath))
                {
                    string[] strings = reader.ReadToEnd().Split(',');
                    Person person = new Person(strings[0], float.Parse(strings[1]), float.Parse(strings[2]));
            ...
            {
                string filePath = "H:\\Semin\\CSH4\\Zahrobsky\\PRG\\lecture\\Files\\" + Name + ".json";
                using (StreamWriter writer= new StreamWriter(filePath))
                {
